...
class TestVerifyProductVersion:
    ...
    def test_TC003_verify_product_version(self, request):
        username = excel.get_data(Constants.EXCEL_PATH,
                                  "Login", 0, "UserName")
        password = excel.get_data(Constants.EXCEL_PATH,
                                  "Login", 0, "Password")
        title = excel.get_data(Constants.EXCEL_PATH,
                               "Login", 0, "Title")
        expected_product_version = excel.get_data(
            Constants.EXCEL_PATH, "Login", 0, "ProductVersion")
        ...
        home.verify_text(actual_product_version,
