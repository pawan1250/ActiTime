...
class HomePage(BasePage):
    ...
    __help_menu = (By.XPATH,
                   "//div[normalize-space(text())='Help']")
    __about_actitime = (By.XPATH,
                        "//a[text()='About your actiTIME']")
    __product_version = (By.XPATH,
                         "//span[@class='productVersion']")
    __close_pop_up = (By.CSS_SELECTOR,
                      "div#aboutPopupCloseButtonId")
